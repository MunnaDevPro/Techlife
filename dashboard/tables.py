...
class CompanyTable(tables.Table):
    ...
    company_email = tables.Column(
        ...
        attrs={
            "th": {"class": "!p-4 !text-left !text-[11px] !font-bold !text-gray-500 !uppercase !tracking-wider !whitespace-nowrap"},
            "td": {"class": "!p-4 !align-middle !text-[13px] !text-gray-600", "style": "max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"}
        }
    )
    ...
    company_phone = tables.Column(
        ...
        attrs={
            "th": {"class": "!p-4 !text-left !text-[11px] !font-bold !text-gray-500 !uppercase !tracking-wider !whitespace-nowrap"},
            "td": {"class": "!p-4 !align-middle !text-[13px] !text-gray-600", "style": "white-space: nowrap;"}
        }
    )
    ...
    category = tables.Column(
        ...
        attrs={
            "th": {"class": "!p-4 !text-left !text-[11px] !font-bold !text-gray-500 !uppercase !tracking-wider !whitespace-nowrap"},
            "td": {"class": "!p-4 !align-middle !text-[13px] !text-gray-600 !font-medium", "style": "white-space: nowrap;"}
        }
    )
    ...
    class Meta:
        model = BlogPost
        fields = ("selection", "thumbnail", "title", "company_email", "company_phone", "category", "created_at", "actions")
        attrs = {
            "class": "!min-w-full !w-full !table-auto !divide-y !divide-gray-200 !border-collapse",
            "thead": {"class": "!bg-gray-50/75"},
            "tbody": {"class": "!divide-y !divide-gray-100 !bg-white"},
    ...
    def render_actions(self, record):
        edit_url = f"/dashboard/company/{record.pk}/edit/"
        view_url = f"/details/{record.slug}/"
